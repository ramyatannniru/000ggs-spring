...
@ComponentScan(basePackages = "com.spring.rest.api")
public class CustomerConfiguration implements WebMvcConfigurer {
	...
	public DataSource myDataSource()
	{
		...
		myDataSource.setJdbcUrl("jdbc:mysql://localhost:3306/details");
		myDataSource.setPassword("RamyaNithuBashipangu1@@");
	...
	public LocalSessionFactoryBean sessionFactory()
	{
		...
		sessionFactory.setPackagesToScan("com.spring.rest.api");
